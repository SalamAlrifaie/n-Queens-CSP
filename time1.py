...
def main(n_values):
    """
    Measures time taken for solving the N-Queens problem for different sizes and plots the results.
    parameters-
    ...
    N_values = [8, 10, 50, 100, 200, 500, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 5500, 6000, 6500, 7000, 7500, 8000, 8500, 9000, 9500, 10000]
    for N in N_values:
        ...
        print(f"N = {N}, Time taken = {elapsed_time:.4f} seconds, Steps = {steps}")
        save_solution(queens, N)

   
    # Plot the results
    plt.figure(figsize=(10, 6))
    plt.plot(N_values, times, marker='o', linestyle='-', color='b', label='Time taken')
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python NAMETHISTHING.py <N as int>")
    else:
        main(sys.argv[1])
